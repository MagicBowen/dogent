...
- After finishing each story, design user acceptance test cases for each user story (guiding users to conduct manual step-by-step testing and acceptance in the sample directory), and append them to `dev/sprint_uat.md` by release.
