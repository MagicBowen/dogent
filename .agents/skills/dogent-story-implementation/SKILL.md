---
name: dogent-story-implementation
...
- Read [references/repo-implementation-checklist.md](references/repo-implementation-checklist.md) for the repo-specific implementation, testing, and pre-UAT tracking checklist.
